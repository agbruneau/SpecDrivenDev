...
| `RAPPORT-FINAL_EscapeBench.md` | **Verdicts consolidés des treize hypothèses** : sept infirmations, six confirmations, ce que chaque confirmation vaut, les quatre défauts de construction trouvés et ce qui reste ouvert | **À lire en premier pour connaître les résultats** |
