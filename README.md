...
| confirmée | de fond | 1 (H-009) | 5 (H-001, H-003, H-006, H-007, H-014) |
| confirmée | restreinte | 5 (H-005, H-007, H-008, H-012, H-013) | 1 (H-012) |
...
*Note du 2026-09-22.* La colonne « Portée » est une lecture ajoutée après coup (définitions sous le résumé); les verdicts, les mesures et les rationales sont ceux des fichiers de verdicts. H-001 est restreinte parce que deux de ses trois paires (0,06 et 0,05 ns) restent sous le plancher de bruit que H-007 mesure dans la même série (0,063 ns), alors que son critère en exige deux; seule la paire de 24 octets le franchit. H-007 est restreinte parce que sa tolérance d'une exception sur trois rendait l'infirmation inatteignable sur la convention d'appel de Go, comme le texte gelé de H-012 l'établit (D-24). H-003 et H-006 sont de banc : le gabarit rendait le passage de 0 à 1 allocation inévitable, et les profils du corpus reproduisent chacun l'une des quatre causes (section 5.1). *Classements révisés le 2026-09-22 (voir* Errata*).* H-005 est restreinte : elle ne tient que par sa tolérance doublée (rapport ≤ 1/2, « trois fois plus lâche que l'affirmation citée » selon [`Campagnes/RAPPORT-CAMPAGNE_C-2026-09-10-1.md`](Campagnes/RAPPORT-CAMPAGNE_C-2026-09-10-1.md), §5); sur la même mesure, H-011, aux tolérances du livre, infirme (×4,45 contre ×4,8). H-012 est restreinte : la seule cellule qui infirmait, 8 octets à champ pointeur, est retirée du jugement en faveur du livre, retrait décidé en connaissant les mesures de `C-2026-09-10-2` (D-24, D-30); jugée, elle franchit le seuil dans ses cinq réplicats (section 5.1). H-009 reste de fond : son témoin `LOCAL` montre la locale gardée sur la pile, de sorte qu'un conteneur qui ne la ferait pas échapper aurait infirmé.

*Note du 2026-09-22 sur les « 8 octets » en disposition en tableau.* Dans les lignes H-001 et H-002, « 8 octets » désigne un type qui occupait en fait 16 octets (deux mots), défaut du harnais trouvé par D-63 (voir *Errata*). Les verdicts n'en dépendent pas : sans cette taille, H-001 garde deux tailles infirmantes, 16 et 24 octets, et le point de bascule de H-002 reste ≤ 24 octets. Les cellules à champs nommés, dont celles de H-007 et H-012, ne sont pas touchées.
...
| H-005 | Préallocation environ 6 fois plus rapide, un cinquième de la mémoire (114), avec une tolérance doublée | Temps ×0,225, mémoire ×0,196 | confirmée | restreinte |
...
| H-012 | Comme H-007, plancher de bruit mesuré sur cinq réplicats | Aucune des cinq cellules jugées ne donne l'avantage au pointeur | confirmée | restreinte |
...
**La forme compte autant que la taille (H-001, H-002, H-007, H-012).** La convention d'appel de Go ne passe une structure dans les registres du processeur que si tous ses champs s'y prêtent, et un tableau de plus d'un élément ne s'y prête pas : la règle est écrite dans la spécification de l'ABI interne de Go, et le banc ne la découvre pas. Une structure de 24 octets faite d'un champ et d'un tableau de deux mots passe donc par la mémoire, alors que la même taille en trois champs nommés passe en registres. La contre-épreuve de la première campagne l'illustre ([`Campagnes/RAPPORT-CAMPAGNE_C-2026-09-10-1.md`](Campagnes/RAPPORT-CAMPAGNE_C-2026-09-10-1.md), §3.1) : à 24 octets, le pointeur l'emporte sur la disposition en tableau (0,50 ns contre 1,06), la valeur sur les champs nommés (0,44 ns contre 0,74). La règle du livre tient donc pour les structures telles qu'on les écrit d'ordinaire, ce que confirment H-007 et H-012; elle échoue sur la disposition en tableau. Ce que le dépôt pourrait ajouter, c'est la mesure de cet effet contre une règle publiée, sous critère gelé; aucune source n'en a été retrouvée par une recherche restreinte ([`Doc/ETAT-DE-L-ART.md`](Doc/ETAT-DE-L-ART.md), §4). Les écarts de H-001 à 8 et 16 octets (0,06 et 0,05 ns) sont du même ordre que le plancher de bruit mesuré pour H-007 (0,06 à 0,09 ns), plancher que le critère de H-001 n'exigeait pas de franchir.

**Latence ou débit (H-004, H-008, H-013).** Le parcours dispersé de H-004 émet des lectures indépendantes, que le processeur recouvre : le rapport ne vaut que 1,9 à 2,8. La chaîne dépendante de H-008 empêche ce recouvrement et fait apparaître la latence réelle de la mémoire, 137 ns, soit 169,9 fois celle du cache L1. L'affirmation du livre est fausse sur la mesure qu'on lui applique d'ordinaire et vraie sur celle qui l'éprouve réellement. La distinction n'est pas neuve : *lmbench* fait de la latence mémoire une mesure de base (McVoy et Staelin, 1996), et Drepper (2007, §3.3) mesure une liste chaînée parcourue en ordre séquentiel ou aléatoire et explique que l'ordre aléatoire empêche le préchargement. Le banc la réplique et n'y ajoute que la confrontation au livre; H-004 éprouvait une opérationnalisation que cette littérature écartait déjà.
...
- **Ce qu'a coûté le processus, mesuré après coup.** QR2 est mesurée après coup, avec les limites de [`Doc/QR2-MESURES.md`](Doc/QR2-MESURES.md). Les onze sessions locales du projet, du 2026-09-08 au 2026-09-14, comptent 55 tours humains, environ 620 minutes de travail actif de l'agent et 6,6 millions de jetons de sortie. De ces jetons, 61 % vont aux trois revues par agents, 11 % aux rédactions contradictoires d'hypothèses et 28 % à l'agent principal. Rapportée au nombre d'hypothèses, la phase EscapeBench a demandé environ trois fois plus de temps actif que LeakLab (cinq fois en y ajoutant le cadrage) et environ neuf fois plus de jetons de sortie (onze fois avec le cadrage), rapports corrigés le 2026-09-22 (voir *Errata*). La comparaison est confondue : LeakLab a réutilisé l'outillage et n'a eu aucune revue par agents. Deux trous limitent ces chiffres : les sessions du 2026-09-12, *supposément* en nuage, où l'audit a été implanté, n'ont laissé aucune transcription locale, et les transcriptions ne sont pas publiées (D-58).
...
- **Validité externe.** Micro-benchmarks sur des types synthétiques, une seule machine, une seule soirée, Windows sur amd64 et Go 1.27.0, alors que le livre se réfère à Go 1.25. L'analyse d'échappement varie d'une version du compilateur à l'autre (Shahsavan, 2026, p. 242) : les résultats sont datés par construction. Depuis le retrait de la CI (D-53), la suite de tests et les campagnes ont été rejouées sous Linux dans WSL2, sur le même processeur (§8.6, D-62, D-20 de LeakLab) : quatre verdicts d'EscapeBench et un de LeakLab y changent. Ce rejeu éprouve le système, pas une autre machine ni une autre architecture : [`Doc/VERIFICATION-HORS-POSTE.md`](Doc/VERIFICATION-HORS-POSTE.md).
...
- Lancer la première campagne arm64 sur la branche `lot-9-arm64`, où le lot 9 de l'audit est désormais appliqué (D-50, D-63; section suivante).
- LeakLab : rejouer la campagne sur arm64 (le rejeu Linux est fait, §8.6); vérifier dans le runtime l'angle mort du profil `goroutineleak` sur les petits mutex, et l'étendre à `sync.RWMutex`; mesurer le compte de goroutines dans une suite réelle, sous `t.Parallel`.
...
### Série arm64 préparée

Le lot 9 de l'audit, consigné comme dette par D-50, est appliqué sur la branche `lot-9-arm64` (D-63), non fusionnée dans `main`. Il ouvre une nouvelle série de comparaison, d'empreinte de harnais `fd4a470c…`; les campagnes Windows et Linux de `main` (`551ce66b…`) restent comparables entre elles, jamais avec celles de cette série. Aucune campagne arm64 n'a été lancée, faute de matériel. La branche apporte : une empreinte qui couvre `harness.go` (A-246); une garde de taille bilatérale (A-073); la ligne de cache comme paramètre de matrice et relevé de provenance (A-081); H-014 et H-015, qui reprennent H-001 et H-002 sur cinq réplicats de processus séparés contre un plancher mesuré par cellule (E-08); H-016, qui reprend H-012 avec une règle de multiplicité (avantage au pointeur à quatre réplicats sur cinq; à trois, la cellule est indéterminée et le verdict qui en dépend non concluant; E-09). Leurs critères citent la série `551ce66b…`, s'y déclarent non concluants, et ne seront gelés qu'à la première campagne arm64. Commandes : `EscapeBench/LANCEMENT.md`, section « Série arm64 », sur la branche.
...
Le livre recommande deux outils qui ne voient pas les fuites, le test et `-race`, et le seul détecteur dynamique qui les a toutes vues est le plus rudimentaire, le compte de goroutines d'un scénario répété. C'est le principe de `goleak`, dont Saioc et coll. (2024) décrivent l'usage chez Uber; le banc le confirme sur un corpus à vérité terrain. Les infirmations suivent le motif d'EscapeBench : le livre décrit un cas particulier sans le dire. `synctest` ne panique que si la goroutine est *durablement* bloquée, notion dont sa documentation exclut les mutex et le réseau. L'interblocage est fatal pour un programme, pas sous `go test`, dont la minuterie d'alarme empêche le runtime de le déclarer (`checkdead`). Le symptôme était connu : l'*issue* golang/go n° 69188 (2024) signale que le délai de `go test` empêche la détection d'interblocage, et Tu et coll. (2019) montraient que le détecteur intégré ne voit que 2 des 21 bogues bloquants qu'ils reproduisent. Le banc le réplique sur les exemples du livre et en situe la cause dans `proc.go`; le texte de l'*issue* ne nomme pas `checkdead`. Oublier `cancel()` coûte de la mémoire, et des goroutines seulement avec un parent que `context` ne reconnaît pas. Le conseil sur `time.After` date d'avant Go 1.23, dont les notes de version annoncent la collecte des minuteries non référencées, ce que H-011 confirme. Le rapport en tire une recommandation pour l'intégration continue : `go vet` explicite, dont `go test` omet l'analyseur `lostcancel` ; contrôle de goroutines dans les tests ; `-timeout` court.
...
Limites propres à LeakLab : corpus synthétique, un seul poste, Windows puis Linux sous WSL2 (§8.6), et une vérité terrain que l'oracle ne vérifie pas pour les courses ni pour l'accessibilité des primitives. Détails : [`Doc/RAPPORT-FINAL_LeakLab.md`](Doc/RAPPORT-FINAL_LeakLab.md), décisions : [`Doc/DECISION_LeakLab.md`](Doc/DECISION_LeakLab.md).

### 8.6 Rejeu sous Linux (2026-09-23)

Les trois campagnes de référence ont été rejouées sous Ubuntu 24.04 dans WSL2, sur la même machine, avec go1.27.0 et les mêmes empreintes de harnais et de critères. Les verdicts Windows publiés ci-dessus restent la série de référence ; ceux-ci s'y ajoutent, ils ne les remplacent pas. Rapports : [`RAPPORT-CAMPAGNE_C-2026-09-23-linux.md`](Campagnes/RAPPORT-CAMPAGNE_C-2026-09-23-linux.md) et [`RAPPORT-CAMPAGNE_R-2026-09-23-linux.md`](Campagnes/RAPPORT-CAMPAGNE_R-2026-09-23-linux.md).

| Banc | Hypothèse | Windows | Linux (WSL2) | Cause de l'écart |
|---|---|---|---|---|
| EscapeBench | H-007 | confirmée | infirmée | le pointeur l'emporte à 16 octets avec champ pointeur, en plus de 8 octets; mécanisme non cherché |
| EscapeBench | H-012 | confirmée | infirmée | même cellule, 5 réplicats sur 5 |
| EscapeBench | H-008 | confirmée | infirmée | latence hors cache 137 → 172 ns, rapport ×169,9 → ×202,3, au-dessus de 200; virtualisation supposée |
| EscapeBench | H-013 | confirmée | infirmée | même rapport que H-008, machine au repos |
| LeakLab | H-007 | confirmée | infirmée | le binaire du corpus lie cgo par `net`, et `checkdead` ne déclare pas l'interblocage d'un programme cgo; sans cgo, l'erreur fatale revient (vérifié) |

Les vingt-deux autres verdicts sont identiques. EscapeBench compte donc neuf infirmées sur treize sous Linux, LeakLab neuf sur quatorze. Ce qui change touche les écarts d'une fraction de nanoseconde, la latence mémoire sous virtualisation et une condition de construction du binaire que le livre ne donne pas. L'échappement, les allocations et la préallocation ne bougent pas.
...
| [`Doc/DECISION.md`](Doc/DECISION.md) | Journal des décisions D-01 à D-65 (D-56 attend la revue des cas d'utilisation par un tiers) : écarts assumés, conception du harnais, statistiques, clôture, correctifs de l'audit, dépôt final, implantation de l'évaluation |
...
| [`Doc/VERIFICATION-HORS-POSTE.md`](Doc/VERIFICATION-HORS-POSTE.md) | Journal des exécutions hors du poste de référence depuis le retrait de la CI, et procédure du rejeu des campagnes sous Linux |
...
| [`Campagnes/RAPPORT-CAMPAGNE_C-2026-09-23-linux.md`](Campagnes/RAPPORT-CAMPAGNE_C-2026-09-23-linux.md) | Rejeu sous Linux des deux campagnes de clôture d'EscapeBench : quatre verdicts dépendent de la plateforme (D-62) |
| [`Campagnes/RAPPORT-CAMPAGNE_R-2026-09-23-linux.md`](Campagnes/RAPPORT-CAMPAGNE_R-2026-09-23-linux.md) | Rejeu sous Linux de la campagne de référence de LeakLab : H-007 infirmée par la liaison cgo (D-20) |
...
| [`Doc/DECISION_LeakLab.md`](Doc/DECISION_LeakLab.md) | Journal des décisions de LeakLab, D-01 à D-20 (D-18 attend la revue des cas d'utilisation) : gel, architecture, oracle, détecteurs, décisions prises après la première campagne |
...
**2026-09-22 — Portée de H-005 et H-012 d'EscapeBench.** Le décompte par portée publié le même jour classait H-005 et H-012 parmi les confirmations de fond (trois : H-005, H-009, H-012). Or ni l'une ni l'autre ne pouvait infirmer l'affirmation telle que le livre l'énonce : H-005 ne tient que par une tolérance doublée, que H-011 ne lui accorde pas sur la même mesure, et H-012 que par le retrait, décidé en connaissant les mesures, de la seule cellule qui infirmait (justification au §4.2). Les deux passent à *restreinte*; la définition des confirmations restreintes le dit désormais. Décompte d'EscapeBench : une confirmation de fond (H-009), cinq restreintes, deux de banc; au résumé, « cinq des confirmations » devient « sept des huit confirmations ». Les cinq confirmations de fond de LeakLab ne tiennent ni par une tolérance élargie ni par un retrait : leur décompte ne change pas. Aucun verdict ni rationale ne change.

**2026-09-22 — Les types « 8 octets » en disposition en tableau occupaient 16 octets.** Dans toute la série d'empreinte de harnais `551ce66b…`, en disposition `ARRAY_FILL`, `Size0008Plain` et `Size0008Ptr` se terminaient par un champ `Fill [0]uint64` que le compilateur gc complète jusqu'au mot suivant : ils occupaient 16 octets, pas 8. La garde de taille du lot 9 l'a trouvé (D-63). Vérifié en lecture seule dans les fichiers de comparaison et de verdicts archivés de `C-2026-09-10-7` et `C-2026-09-10-11`, les deux campagnes de cette série qui jugent H-001 et H-002 : sans la cellule de 8 octets, H-001 garde deux tailles infirmantes (16 et 24 octets) et le point de bascule de H-002 vaut 16 octets sans champ pointeur et 24 avec, donc ≤ 24. `C-2026-09-10-1` porte une autre empreinte (`022b7a58…`) : le défaut n'y est ni établi ni exclu, et ses verdicts ne comptent pas la cellule de 8 octets sans champ pointeur (H-001 infirme sur 16 et 24 octets, bascule de H-002 à 16 et 24). Non vérifié : l'effet sur les cellules `ARRAY_FILL` de 8 octets que comptent H-003, H-006 et H-009, jugé vraisemblablement nul par D-63. Les verdicts ne changent pas; dans les rationales et dans ce document (§4.2, §4.3, pour H-001 et H-002), « 8 octets » ou « 8 o » en disposition en tableau désigne un type de deux mots. Les cellules à champs nommés ne sont pas touchées.

**2026-09-22 — Coût d'une hypothèse, EscapeBench contre LeakLab.** Le §5.3 et [`Doc/QR2-MESURES.md`](Doc/QR2-MESURES.md) (§4), publiés le même jour, disaient qu'une hypothèse d'EscapeBench avait demandé « environ dix fois plus de temps et de jetons » qu'une hypothèse de LeakLab. Les agrégats de QR2-MESURES donnent environ 3 fois le temps actif (21 min contre 6,7; 5 fois avec le cadrage) et environ 9 fois les jetons de sortie (235 k contre 25 k; 11 fois avec le cadrage). Le facteur de dix n'approchait que les jetons. Aucune mesure ne change.
...
Travaux cités *(ajout du 2026-09-22)*. DOI ou URL repris de [`Doc/ETAT-DE-L-ART.md`](Doc/ETAT-DE-L-ART.md), §5, qui donne pour chacun jusqu'où la vérification est allée; tous : *vérifiés par agent le 2026-09-22, lecture du chercheur à faire*.

Drepper, U. (2007). *What Every Programmer Should Know About Memory*. Red Hat. https://www.akkadia.org/drepper/cpumemory.pdf.

Ernst, N. A., Baldassarre, M. T. (2023). Registered reports in software engineering. *Empirical Software Engineering* 28(2), 55. https://doi.org/10.1007/s10664-022-10277-5.

Georges, A., Buytaert, D., Eeckhout, L. (2007). Statistically Rigorous Java Performance Evaluation. *OOPSLA '07*. https://doi.org/10.1145/1297027.1297033.

Go. *Go internal ABI specification*, `src/cmd/compile/abi-internal.md`. https://go.googlesource.com/go/+/refs/heads/master/src/cmd/compile/abi-internal.md.

Go (2024). Go 1.23 Release Notes, section `time`. https://go.dev/doc/go1.23.

Go. Package `testing/synctest`, documentation. https://pkg.go.dev/testing/synctest.

golang/go (2024). Issue n° 69188, *testing: timeouts prevent deadlock detection from working*. https://github.com/golang/go/issues/69188.

Kalibera, T., Jones, R. (2013). Rigorous Benchmarking in Reasonable Time. *ISMM '13*. https://doi.org/10.1145/2464157.2464160.

McVoy, L., Staelin, C. (1996). lmbench: Portable Tools for Performance Analysis. *USENIX 1996 Annual Technical Conference*. https://www.usenix.org/conference/usenix-1996-annual-technical-conference/lmbench-portable-tools-performance-analysis.

Mytkowicz, T., Diwan, A., Hauswirth, M., Sweeney, P. F. (2009). Producing Wrong Data Without Doing Anything Obviously Wrong! *ASPLOS '09*. https://doi.org/10.1145/1508244.1508275.
...
Saioc, G.-V., Shirchenko, D., Chabbi, M. (2024). Unveiling and Vanquishing Goroutine Leaks in Enterprise Microservices: A Dynamic Analysis Approach. *CGO 2024*. https://doi.org/10.1109/CGO57630.2024.10444835.

Saioc, G.-V., Lee, I.-T. A., Møller, A., Chabbi, M. (2025). Dynamic Partial Deadlock Detection and Recovery via Garbage Collection. *ASPLOS '25*, vol. 2. https://doi.org/10.1145/3676641.3715990.

Tu, T., Liu, X., Song, L., Zhang, Y. (2019). Understanding Real-World Concurrency Bugs in Go. *ASPLOS '19*. https://doi.org/10.1145/3297858.3304069.

Uber. `goleak`, dépôt de code. https://github.com/uber-go/goleak.
