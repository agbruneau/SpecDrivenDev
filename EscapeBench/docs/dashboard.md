...
|---|---|---|---|---|---|
| H-001 | p. 245, 253 — « copying a small struct can be cheaper than passing a pointer to it » | UC-003, UC-004, UC-005 | Oui | C-2026-09-10-11 | REFUTED |
| H-002 | p. 253 — valeur « when the data type is small (typically one to three machine words) » | UC-003, UC-004, UC-005 | Oui | C-2026-09-10-11 | REFUTED |
...
| H-010 | p. 256 — « a small change in how you pass a struct (by value vs. pointer) doubles the number of allocations » | UC-001, UC-003, UC-004, UC-005 | Oui | C-2026-09-10-11 | REFUTED |
| H-011 | p. 114 — « runs significantly faster (about 6×) and uses roughly one-fifth the memory, with only a single allocation », pour `const n = 100_000` | UC-003, UC-005 | Oui | C-2026-09-10-11 | REFUTED |
...
| Hypothèses avec verdict | 13 | 13 | 0 | 0 | 100 % |
