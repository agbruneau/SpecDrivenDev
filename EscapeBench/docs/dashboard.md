...
Généré par `escapebench dashboard` et `escapebench verdict` (UC-005, FR-007) ; ne pas éditer à la main (BR-005-3). Régénéré le 2026-09-10 19:17 UTC.
...
| H-007 | p. 253 — valeur « when the data type is small (typically one to three machine words) », éprouvée sur une disposition assignable aux registres | UC-001, UC-003, UC-004, UC-005 | Oui | C-2026-09-10-2 | CONFIRMED |
| H-008 | p. 254 — « roughly 10× to 200× » entre un succès de cache annoncé sous 10 ns et un défaut servi par la mémoire principale annoncé au-delà de 100 ns | UC-001, UC-003, UC-005 | Oui | C-2026-09-10-2 | CONFIRMED |
| H-009 | p. 241 — la quatrième cause est illustrée par une map, puis généralisée : « This rule also applies to slices, structs, or any container that is already heap-allocated » | UC-001, UC-002, UC-005 | Oui | C-2026-09-10-2 | CONFIRMED |
| H-010 | p. 256 — « a small change in how you pass a struct (by value vs. pointer) doubles the number of allocations » | UC-001, UC-003, UC-004, UC-005 | Oui | C-2026-09-10-2 | REFUTED |
| H-011 | p. 114 — « runs significantly faster (about 6×) and uses roughly one-fifth the memory, with only a single allocation », pour `const n = 100_000` | UC-003, UC-005 | Oui | C-2026-09-10-2 | REFUTED |
...
| Hypothèses avec verdict | 13 | 5 | 0 | 8 | 38 % |
