...
La première campagne a tourné sur le banc du commit `139c35c`. Avant d'en croire les verdicts, chaque résultat contraire à l'attente de l'auteur a été relu jusqu'à sa cause. Trois venaient du banc, un du détecteur jugé.
