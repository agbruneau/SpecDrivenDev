...
- **Les points de l'audit laissés au chercheur** *(ajout du 2026-09-14)*. Le lot 9 (A-073, A-081 et le volet code de A-246) changerait l'empreinte du harnais et rendrait les campagnes archivées incomparables ; A-036 changerait les verdicts de H-003 et H-004 rendus sur un corpus partiel. Voir [`AUDIT.md`](AUDIT.md), *État d'implantation*.
