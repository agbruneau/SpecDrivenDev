...
**Objet évalué** : dépôt `agbruneau/Prospection`, branche `main`, commit `5d7d9c8` (2026-09-14), arbre de travail propre.
**Date** : 2026-09-15.
...
| E-02 | M | C10 | Trois ouvrages sous droit d'auteur committés en PDF dans le dépôt public, retirés de l'arbre (`873fc23`, `fc5dbd7`), présents dans l'historique. Le README affirme qu'ils ne sont pas distribués. **Corrigé le 2026-09-15 (D-54)** : historique réécrit sans les trois PDF. |
...
Tous exécutés le 2026-09-15 sur le commit `5d7d9c8`, poste Windows 11, `go1.27.0 windows/amd64`, `jq-1.8.2`.
