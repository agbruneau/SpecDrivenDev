...
- **Les décomptes de l'audit ne concordent pas.** Le fichier d'exécution donne 187 constats après dédoublonnage et 119 retenus. `Doc/AUDIT.md` écrit 190 items, dont 102 confirmés, 4 rejetés et 84 non vérifiés. L'écart est expliqué depuis le 2026-09-22 par D-65 ([`DECISION.md`](DECISION.md)) et l'[erratum de `AUDIT.md`](AUDIT.md#erratum-du-2026-09-22--décomptes-de-la-méthode) : constats inscrits deux fois, confirmés publiés comme non vérifiés, non vérifiés que le fichier réfute par défaut.
...
**Ce que les chiffres ne disent pas.** Ils ne disent pas si le processus a *préservé la traçabilité* : c'est la question de QR2, et elle reste qualitative (README §5.3). Ils ne disent pas non plus ce qu'aurait coûté la même étude sans spécification ni revues : il n'y a pas de groupe témoin. Enfin, l'écart entre EscapeBench et LeakLab (par hypothèse, environ 3 fois le temps actif et 9 fois les jetons de sortie; 5 et 11 fois avec le cadrage) ne s'attribue pas à une seule cause. LeakLab a réutilisé le vocabulaire et l'outillage, et n'a eu aucune revue par agents : la comparaison est confondue.

*Erratum du 2026-09-22.* La version publiée le même jour donnait à cet écart « un facteur de 10 environ par hypothèse », que le README reprenait pour le temps comme pour les jetons. Les lignes du tableau ci-dessus donnent 21 min contre 6,7 min actives (×3,2; ×5,1 avec le cadrage) et 235 k contre 25 k jetons de sortie (×9,5; ×11,3 avec le cadrage), rapports recalculés sur les agrégats non arrondis du script, rejoué ce jour-là avec les mêmes agrégats de projet. Aucune mesure ne change.
